...
import com.github.zftpserver.server.SessionThread;
import com.github.zftpserver.server.TcpListener;
...
//        listenSocket.bind(new InetSocketAddress("192.168.43.1",2121));
    ...
    public static InetAddress getLocalInetAddress() {
        ...
        Cat.w("getLocalInetAddress:"+returnAddress.getHostAddress());
